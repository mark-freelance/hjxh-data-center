...
SELECT 
datename(week,a1.date_time) as week1,
sum(TaokePromotionfy) as TaokePromotionfy
FROM LS_Sale a1
where a1.Shop_bh='${shopbh}'
and year(a1.date_time) = left('${jssj}',4) and a1.date_time <= '${jssj}'
group by datename(week,a1.date_time)
...
SELECT 
datename(week,a1.date_time) as week1,
sum(AIPromotionfy) as AIPromotionfy
FROM LS_Sale a1
where a1.Shop_bh='${shopbh}'
and year(a1.date_time) = left('${jssj}',4) and a1.date_time <= '${jssj}'
group by datename(week,a1.date_time)
...
a4.TaokePromotionfy as '淘客推广',
a5.AIPromotionfy as 'AI推广',
...
<Features width="600" height="400"/>
<ReportletName showPI="true">
<![CDATA[/三级页面/京东-京东快车明细-周.cpt]]></ReportletName>
<Attr>
<DialogAttr class="com.fr.js.ReportletHyperlinkDialogAttr">
<O>
<![CDATA[]]></O>
...
<Features width="600" height="400"/>
<ReportletName showPI="true">
<![CDATA[/三级页面/京东-京东展位明细-周.cpt]]></ReportletName>
<Attr>
<DialogAttr class="com.fr.js.ReportletHyperlinkDialogAttr">
<O>
<![CDATA[]]></O>
...
<Features width="600" height="400"/>
<ReportletName showPI="true">
<![CDATA[/三级页面/京东-京东直投明细-周.cpt]]></ReportletName>
<Attr>
<DialogAttr class="com.fr.js.ReportletHyperlinkDialogAttr">
<O>
<![CDATA[]]></O>
